    ...
    <div class="row">
      <div class="col-md-9">
        <div class="form-content">
          <form action="{{route('admin.admin-groups.store')}}" method="POST" enctype="multipart/form-data" >
            <div class="form-row">
              ...
              <div class="form-group col-md-9">
                ...
                <input type="text" name="desc" class="form-control @error('desc') is-invalid @enderror" id="inputDesc" value="{{old('desc')}}">
                  @error('desc')
                  <span class="invalid-feedback" role="alert">
                     <strong>{{ $message }}</strong>
                  </span>
