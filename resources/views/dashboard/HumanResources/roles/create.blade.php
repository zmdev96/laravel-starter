...
<div class="card shadow mb-4">
    <div class="card-header  d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">{{__('Create new Role')}}</h6>
    </div>
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-9">
                <div class="form-content">
                    <form action="{{dashboard_route('hr.roles.store')}}" method="POST">
                        <div class="form-row">
                                                ...
                                                <div class="card shadow mb-4 p-2">
                                                    ...
                                                    @foreach($permission as $singel_permission)
                                                        <div class="singel-privi  ">
                                                            <input type="checkbox" name="permissions[]" value="{{$singel_permission->id}}" id="{{$singel_permission->id}}">
